...
typedef void (*st_matrix3x3_clone_t)(st_modctx_t *matrix3x3_ctx,
...
typedef void (*st_matrix3x3_dvshearing_t)(st_modctx_t *matrix3x3_ctx,
 st_matrix3x3_t *matrix, float degrees);
typedef void (*st_matrix3x3_apply_t)(st_modctx_t *matrix3x3_ctx,
 st_matrix3x3_t *matrix, const st_matrix3x3_t *other);
typedef void (*st_matrix3x3_translate_t)(st_modctx_t *matrix3x3_ctx,
 st_matrix3x3_t *matrix, float x, float y);
typedef void (*st_matrix3x3_scale_t)(st_modctx_t *matrix3x3_ctx,
 st_matrix3x3_t *matrix, float hscale, float vscale);
typedef void (*st_matrix3x3_rrotate_t)(st_modctx_t *matrix3x3_ctx,
 st_matrix3x3_t *matrix, float radians);
typedef void (*st_matrix3x3_drotate_t)(st_modctx_t *matrix3x3_ctx,
 st_matrix3x3_t *matrix, float degrees);
typedef void (*st_matrix3x3_rhshear_t)(st_modctx_t *matrix3x3_ctx,
 st_matrix3x3_t *matrix, float radians);
typedef void (*st_matrix3x3_dhshear_t)(st_modctx_t *matrix3x3_ctx,
 st_matrix3x3_t *matrix, float degrees);
typedef void (*st_matrix3x3_rvshear_t)(st_modctx_t *matrix3x3_ctx,
 st_matrix3x3_t *matrix, float radians);
typedef void (*st_matrix3x3_dvshear_t)(st_modctx_t *matrix3x3_ctx,
 st_matrix3x3_t *matrix, float degrees);
typedef void (*st_matrix3x3_get_data_t)(st_modctx_t *matrix3x3_ctx, float *r1c1,

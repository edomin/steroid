...
void *st_module_htable_hash_table_get_func(const char *func_name) {
    st_modfuncstbl_t *funcs_table =
     &st_module_htable_hash_table_funcs_table;
...
st_moddata_t *st_module_htable_hash_table_init(void *modsmgr,

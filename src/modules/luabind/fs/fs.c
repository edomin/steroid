...
void *st_module_luabind_fs_get_func(const char *func_name) {
    st_modfuncstbl_t *funcs_table = &st_module_luabind_fs_funcs_table;
...
st_moddata_t *st_module_luabind_fs_init(st_modsmgr_t *modsmgr,
 st_modsmgr_funcs_t *modsmgr_funcs) {
    ...
    if (err) {
        ...
        fprintf(stderr, "Unable to init module \"luabind_fs\": %s\n",
         err_msg_buf);
    ...
    return &st_module_luabind_fs_data;
}

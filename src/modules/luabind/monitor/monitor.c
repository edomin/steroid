...
#define CTX_METATABLE_NAME     "st_monitor_ctx"
#define MONITOR_METATABLE_NAME "st_monitor"
...
void *st_module_luabind_monitor_get_func(const char *func_name) {
    st_modfuncstbl_t *funcs_table = &st_module_luabind_monitor_funcs_table;
...
st_moddata_t *st_module_luabind_monitor_init(st_modsmgr_t *modsmgr,
 st_modsmgr_funcs_t *modsmgr_funcs) {
    ...
    if (err) {
        ...
        fprintf(stderr, "Unable to init module \"luabind_monitor\": %s\n",
         err_msg_buf);
    ...
    return &st_module_luabind_monitor_data;
}
...
static bool st_luabind_import_functions(st_modctx_t *luabind_ctx,
 st_modctx_t *lua_ctx, st_modctx_t *logger_ctx) {
    ...
    ST_LOAD_GLOBAL_FUNCTION("luabind_monitor", lua, register_cfunction);

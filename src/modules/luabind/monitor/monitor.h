#ifndef ST_MODULES_LUABIND_MONITOR_MONITOR_H
#define ST_MODULES_LUABIND_MONITOR_MONITOR_H
...
} st_luabind_monitor_logger_t;

typedef struct {
    st_modctx_t *ctx;
} st_luabind_monitor_lua_t;

typedef struct {
    st_luabind_monitor_logger_t logger;
    st_luabind_monitor_lua_t    lua;
} st_luabind_monitor_t;

st_luabind_funcs_t st_luabind_monitor_funcs = {

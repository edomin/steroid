...
st_moddata_t *st_module_luabind_gfxctx_init(void *modsmgr,
 st_modsmgr_funcs_t *modsmgr_funcs) {
    ...
    if (err) {
        ...
        fprintf(stderr, "Unable to init module \"luabind_gfxctx\": %s\n",
         err_msg_buf);
    ...
    return &st_module_luabind_gfxctx_data;
}
...
static bool st_luabind_import_functions(st_modctx_t *luabind_ctx,
 st_modctx_t *lua_ctx, st_modctx_t *logger_ctx) {
    ...
    ST_LOAD_GLOBAL_FUNCTION("luabind_gfxctx", lua, register_cfunction);

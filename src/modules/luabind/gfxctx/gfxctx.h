#ifndef ST_MODULES_LUABIND_GFXCTX_OPTS_H
#define ST_MODULES_LUABIND_GFXCTX_OPTS_H
...
st_luabind_funcs_t st_luabind_gfxctx_funcs = {
    .luabind_init = st_luabind_init,
    .luabind_quit = st_luabind_quit,
};

#define FUNCS_COUNT 2
st_modfuncstbl_t st_module_luabind_gfxctx_funcs_table = {
...
#endif /* ST_MODULES_LUABIND_GFXCTX_OPTS_H */

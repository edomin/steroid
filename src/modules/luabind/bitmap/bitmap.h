#ifndef ST_MODULES_LUABIND_BITMAP_BITMAP_H
#define ST_MODULES_LUABIND_BITMAP_BITMAP_H
...
st_luabind_funcs_t st_luabind_bitmap_funcs = {
    .luabind_init = st_luabind_init,
    .luabind_quit = st_luabind_quit,
};

st_modfuncentry_t st_module_luabind_bitmap_funcs[] = {
    {"init", st_luabind_init},
    {"quit", st_luabind_quit},
    {NULL, NULL},
};

#endif /* ST_MODULES_LUABIND_BITMAP_BITMAP_H */
